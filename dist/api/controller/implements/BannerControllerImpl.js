...
let BannerControllerImpl = class BannerControllerImpl {
    ...
    makeBanner(bannerData) {
        const { title, productType, mediaLocation, startTime, endTime } = bannerData;
        return this.bannerService.getOverlapBannerSchedules(title, productType, mediaLocation, startTime, endTime);
    }
    readBannerDetail(id) {
